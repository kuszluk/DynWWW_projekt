...
<head>
    ...
    <title>Kalkulator kredytowy v2.0</title>

    <!-- CSS -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway:400,700">
    <link rel="stylesheet" href="<?php echo _APP_URL. '/assets/bootstrap/css/bootstrap.min.css';?>">
    <link rel="stylesheet" href="<?php echo _APP_URL. '/assets/font-awesome/css/font-awesome.min.css';?>">
    <link rel="stylesheet" href="<?php echo _APP_URL. '/assets/css/animate.css';?>">
    <link rel="stylesheet" href="<?php echo _APP_URL. '/assets/css/style.css';?>">
    <link rel="stylesheet" href="<?php echo _APP_URL. '/assets/css/media-queries.css';?>">
    ...
    <link rel="shortcut icon" href="<?php echo _APP_URL. '/assets/ico/favicon.png';?>">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo _APP_URL. '/assets/ico/apple-touch-icon-144-precomposed.png';?>">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo _APP_URL. '/assets/ico/apple-touch-icon-114-precomposed.png';?>">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo _APP_URL. '/assets/ico/apple-touch-icon-72-precomposed.png';?>">
    <link rel="apple-touch-icon-precomposed" href="<?php echo _APP_URL. '/assets/ico/apple-touch-icon-57-precomposed.png';?>">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4 r-form-1-box wow fadeInUp">
                ...
                <div class="r-form-1-bottom">
                    <form role="form" action="<?php print(_APP_URL);?>/app/calc.php" method="post">
            ...
            if(!empty($messages) || isset($result)){
                echo '<div class="col-sm-3 r-form-1-box msg-box wow fadeInUp">';

                if (!empty($messages)) {
                    echo '<p class="msg-box-header">BŁĘDY: </p>';
                    echo '<ol>';
                ...
                if (isset($result)){
                    echo '<p class="msg-box-header">WYNIK: </p>';
                    echo '<p id="wynik"><span class="msg-wynik"> Rata kredytu: </span>'.$result .' zł</p>';
                    echo '<p id="wynik"><span class="msg-wynik"> Koszt kredytu: </span>'.$koszt .' zł</p>';
                }
...
<footer>
    © Regy Bootstrap Registration Template by AZMIND
</footer>
...
<!-- Javascript -->
<script src="<?php echo _APP_URL. '/assets/js/jquery-1.11.1.min.js';?>"></script>
<script src="<?php echo _APP_URL. '/assets/bootstrap/js/bootstrap.min.js';?>"></script>
<script src="<?php echo _APP_URL. '/assets/js/jquery.backstretch.min.js';?>"></script>
<script src="<?php echo _APP_URL. '/assets/js/wow.min.js';?>"></script>
<script src="<?php echo _APP_URL. '/assets/js/retina-1.1.0.min.js';?>"></script>
<script src="<?php echo _APP_URL. '/assets/js/scripts.js';?>"></script>

<!--[if lt IE 10]>
<script src="<?php echo _APP_URL. '/assets/js/placeholder.js';?>"></script>
<![endif]-->
